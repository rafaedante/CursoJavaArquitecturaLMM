package com.eduit.ejemploActiveMQ;
//http://activemq.apache.org/index.html de aca bajamos el serve de MQ
...
//Esto no es más que un pequeño ejemplo de uso de JMS. En concreto, bajamos y arrancamos ActiveMQ como servidor de JMS
//y el siguiente programita hace de cliente de Chat. Podemos arrancarlo varias veces, pero en el mismo ordenador donde 
//corre ActiveMQ, puesto que lo busca en localhost. Debemos añadir activemq-all-5.6.0.jar en el CLASSPATH, este jar viene con ActiveMQ.
public class Chat {
